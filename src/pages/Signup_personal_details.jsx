...
function Signup_personal_details() {
  return (
<div className='h-screen overflow-y-hidden'>
  ...
  <div className='mt-5'>
   ...
   <p className='text-sm'>This will help us to know you better </p>
    ...
    <img src='images/twoman.svg' className='h-80' alt='twoman'></img>
    <div>
  ...
  <div className='rounded-lg  p-5 top-1/2 absolute right-10 shadow-2xl bg-white transform -translate-x-1/2 -translate-y-1/2 w-[30%]'>
                <div className='flex flex-row justify-between font-mont'>
                    ...
                    <p className='text-lg'>Have an Account?<br></br><Link to="/"><span className='text-[#ECBC76]'>Sign In</span></Link></p>
                </div>
                <div>
...
export default Signup_personal_details