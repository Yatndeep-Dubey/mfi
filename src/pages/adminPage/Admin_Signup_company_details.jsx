...
function Admin_Signup_company_details() {
  return (
<div className='h-screen overflow-y-hidden'>
  ...
  <div className='mt-5 hidden lg:block'>
   ...
   <p className='text-sm'>This will help us to know you better </p>
    ...
    <img src='images/girlwithcartoon.svg' className=' absolute lg:relative bottom-0 h-[120px] sm:h-[140px] mx-auto lg:mx-0  lg:h-80' alt='twoman'></img>
  ...
  <div className='rounded-lg p-2 px-4 sm:p-5 lg:top-1/2 sm:absolute mx-auto right-[12%] sm:right-[22%] lg:right-10 shadow-2xl bg-white transform lg:-translate-x-1/2 -translate-y-[65%] lg:-translate-y-1/2 w-[90vw] sm:w-[50vw] lg:w-[30%]'>
                <div className='flex flex-row justify-between font-mont'>
                    <h1 className=' text-sm lg:text-sm '>Welcome to <span className='text-[#ECBC76]'>MFI</span></h1>
                    <p className='text-sm lg:text-lg'>Have an Account?<br></br><span className='text-[#ECBC76]'>Sign In</span></p>
                </div>
                <div>
...
export default Admin_Signup_company_details