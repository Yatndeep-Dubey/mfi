        ...
        <div>
            <div className='flex'>
                <div className='w-1/2 h-screen bg-[#ECBC76]'>
                    <img src='images/mfilogo.svg' alt='logo' className='mx-5'></img>
                    <div className='rounded-lg w-[50%] bg-white mx-5 mt-10 p-2 space-y-2'>
             ...
             <div className='rounded-lg  p-10 top-1/2 left-1/2  absolute shadow-2xl bg-white transform -translate-x-1/2 -translate-y-1/2 w-[40%]'>
                <div className='flex flex-row justify-between'>
                    <h1 className='text-xl'>Welcome to <span className='text-[#ECBC76]'>MFI</span></h1>
                    <p className='text-lg'>No Account?<br></br><span className='text-[#ECBC76]'><Link to='/signup_personal_details'>Sign Up</Link></span></p>
                </div>
                <div>
                    <h1 className='text-4xl -mt-2 font-semibold'>Sign In</h1>
                </div>
                <div className='mt-5 space-y-3'>
                    <div className='space-y-1'>
                        <h1 className='font-bold'>Enter Your Username or Email Address</h1>
                    ...
                    <div className='space-y-1'>
                        ...
                        <p className='text-[#AD3113]'>Forgot Password</p>
                        </div>
                    ...
                    <div className='space-y-1'>
                        <h1 className='font-bold'>Enter Your Membership Number</h1>
                          <input type='text'className='w-[100%] border-2 border-[#ADADAD] outline-none rounded-lg p-2' placeholder='Membership Number'></input>
                    </div>
                    <div>
                        <button className='bg-[#402C6B] rounded-lg text-white text-center p-2 w-full'>Sign In</button>
                    </div>
                    <p className='text-gray-400 text-center'>OR</p>
                    <div className='flex flex-row justify-between items-center'>
                        <div className='flex flex-row space-x-2 items-center w-fit bg-[#402C6B33] py-2 px-12 rounded-lg'>
                        ...
                        <div className='bg-[#F6F6F6] p-2 rounded-lg'>
                            <img src='images/linkedin.svg' alt='fb'></img>
                        </div>
                    </div>
                </div>
             </div>
               ...
               <div className='w-1/2  flex justify-end'>
                 <img src='images/flyingman.svg' alt='flying man' className='w-96'></img>
               </div>
